/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 40799d8a2fa919c757c5f188aee85c49)
// Runtime types generated with workerd@1.20260611.1 2026-06-12 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	SHOP_STORAGE: KVNamespace;
	ASSETS: Fetcher;
	SHOPWARE_APP_NAME: "FroshMobilePush";
	SHOPWARE_APP_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SHOPWARE_APP_NAME" | "SHOPWARE_APP_SECRET" | "FCM_SERVICE_ACCOUNT">> {}
}
